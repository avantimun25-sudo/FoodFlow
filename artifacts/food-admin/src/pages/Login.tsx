...
import {
  UtensilsCrossed, Loader2, ArrowRight, ChefHat,
...
export default function Login() {
  ...
  const { mutate: submit, isPending: isRegisterPending } = useSubmitRestaurantRequest();
    ...
    doAdminLogin(
      { data: { email, password } },
      {
        onSuccess: (data) => {
          ...
          navigate(data.user.role === "admin" ? "/" : "/restaurant/dashboard");
        },
        onError: () => {
          doCustomerLogin(
            { data: { email, password } },
              ...
              >
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-muted text-sm font-medium transition-all text-center"
                  >
              ...
              >
                {registerSubmitted ? (
                  ...
                  <>
                    ...
                    <p className="text-muted-foreground mb-7">
                      Join FoodAdmin's delivery network.
                    </p>
